                ...
                <form class="search-box d-flex gap-2 align-items-center" id="js_rating_star_form_search">
	                <div class="form-group mb-0">
		                <select name="type" class="form-control">
			                ...
			                @foreach (\RatingStar\Supports\RatingStarHelper::module() as $item)
    ...
    $(function(){
	    class RatingStarTableHandle {
		    ...
		    load(element) {
			    ...
			    let data = {
				    'action'    : 'RatingStar\\Ajax\\Admin\\RatingStarAjax::load',
			...
			showReply(element) {
				...
				let data = {
					action : 'RatingStar\\Ajax\\Admin\\RatingStarAjax::commentLoad',
					id     : this.id
				};
			...
			addReply(element) {
				...
				data.action       = 'RatingStar\\Ajax\\Admin\\RatingStarAjax::commentAdd';
		    ...
		    editReply(element) {
			    ...
			    data.action       = 'RatingStar\\Ajax\\Admin\\RatingStarAjax::commentEdit';
		    ...
		    deleteReply(element) {
			    ...
			    let data = {
				    action : 'RatingStar\\Ajax\\Admin\\RatingStarAjax::commentDelete',
				    id     : this.replyId
			    };
			...
			clickPublic(element) {
				...
				let data = {
					action : 'RatingStar\\Ajax\\Admin\\RatingStarAjax::status',
					id     : this.id,
					status :'public',
				};
			...
			save(element) {
				...
				data.action       = 'RatingStar\\Ajax\\Admin\\RatingStarAjax::save';
		    ...
		    delete(element) {
			    ...
			    let data    = {
				    action  : 'RatingStar\\Ajax\\Admin\\RatingStarAjax::delete',
				    id      : this.id,
			    }
