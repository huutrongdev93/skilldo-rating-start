<div class="box-content">
	...
	<div class="form-group">
		<label class="form-check radio d-block">
			<input type="radio" name="rating_star_setting[autoDataType]" value="auto" class="js_rating_star_input_type form-check-input" {{ (config('rating-star::config.autoDataType') == 'auto') ? 'checked' : ''}}> Dữ liệu có sẵn của sikido
		</label>
		<label class="form-check radio d-block">
			<input type="radio" name="rating_star_setting[autoDataType]" value="handmade" class="js_rating_star_input_type form-check-input" {{ (config('rating-star::config.autoDataType') == 'handmade') ? 'checked' : ''}}> Tự tạo
		</label>
	</div>
	<div class="rating_star_data_box rating_star_data_handmade" id="js_rating_star_handmade_box" style="display:{{ (config('rating-star::config.autoDataType') == 'auto') ? 'none' : 'block'}}" data-handmade="{{ htmlentities($dataAuto)}}">
