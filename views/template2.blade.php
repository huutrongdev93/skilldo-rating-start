        ...
        <div class="rsr__right">
            <div class="row">
                <div class="form-group col-md-12 text-center">
                    <p class="text-center"><span class="text">{{ trans('rating-star::template.rate.count', ['count' => $count]) }}</span></p>
                    <button type="button" class="btn btn-theme btn-effect-default btn-block js_rating_star_btn__review">{{ trans('rating-star::template.attach') }}</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="modal__overlay" tabindex="-1" data-micromodal-close>
        <div class="modal__container" role="dialog" aria-modal="true" aria-labelledby="modal-1-title">
            <header class="modal__header">
                <h2 class="modal__title">{{ trans('rating-star::template.rate') }} {{ $objectName }}</h2>
                <button class="modal__close" aria-label="Close modal" data-micromodal-close></button>
            </header>
            <div class="modal__content js_rating_star_modal__review">
                <div class="rating-reviews__success">
                    <div class="text-center">
                        {!!Image::plugin('rating-star', 'assets/images/success.png')->html() !!}
...
<script type="text/javascript" defer>
    $(function(){
        ...
        rating_star_form.submit(function(){
            ...
            form_data.append('action', 'RatingStar\\Ajax\\Web\\RatingStarAjax::reviewSave');
