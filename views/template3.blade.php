<div style="display: none;" class="review-post-star-ratings review-valign-bottom review-align-right" data-id="{{ $object->id }}">
    <div class="review-stars">
        ...
        <div class="review-stars-active" style="width: 135px;">
            ...
            <div class="review-star-bg">
                @include('partials.star-svg', ['star' => $star, 'fill' => '#FDD835', 'stroke' => '#FFB500'])
            </div>
        </div>
    </div>
    <style>
    ...
    <div class="review-legend">
        <strong class="review-score">{{ number_format($star, 1) }}</strong><span class="review-muted">/</span><strong>5</strong>
        <span class="review-muted">( </span><strong class="review-count">{{ $count }}</strong> <span class="review-muted">{{ trans('rating-star::template.voted') }}</span><span class="review-muted"> )</span>
    </div>
</div>
<script type="text/javascript" defer>
    $(function(){
        ...
        $('.review-post-star-ratings .review-stars-inactive .review-star').click(function(){
            ...
            let data = {
                'action'        : 'RatingStar\\Ajax\\Web\\RatingStarAjax::reviewSave',
                'object_type'   : '{{ $type }}',
